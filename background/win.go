...
const (
	//SPI_GETSCREENSAVEACTIVE 获取屏幕保护开关
	SPI_GETSCREENSAVEACTIVE = 0x0010
	//SPI_SETSCREENSAVEACTIVE 设置屏保开关
	SPI_SETSCREENSAVEACTIVE = 0x0011
	//SPI_SETSCREENSAVETIMEOUT 设置屏保等待时间
	SPI_SETSCREENSAVETIMEOUT = 0x000F
	//SPI_SETSCREENSAVESECURE 设备屏保在恢复时显示屏幕
...
//MustLoadLibrary MustLoadLibrary
...
//MustGetProcAddress MustGetProcAddress
